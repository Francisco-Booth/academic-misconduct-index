    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <section className="mb-14">
        ...
        <div className="space-y-3 text-sm text-[var(--muted)] leading-relaxed">
          ...
          <p><strong className="text-ink">Empty Q2 quadrant.</strong> The Q2 quadrant ("Aware and fighting it") is currently empty: no country in the 39-country set simultaneously combines high estimated prevalence with a strong institutional response on the AMI axes. That gap is a substantive finding in the current data, not a methodology error. The jurisdictions with the strongest response frameworks (Australia, the United Kingdom, Ireland, and Canada) sit with comparatively low estimated prevalence, while countries with the highest prevalence scores uniformly show weaker response quality. Q2 may become populated as coverage expands to more countries or as additional jurisdictions strengthen enforcement while misconduct signals remain high.</p>
          <p><strong className="text-ink">Norway and Sweden.</strong> Some countries with strong academic integrity frameworks — specifically Norway and Sweden — can score higher on the Prevalence axis than their documented misconduct rates in the peer-reviewed literature might suggest. That pattern is driven in part by comparatively high Google Trends volume for AI-submission and contract-cheating keywords, which in these countries often reflects researchers and educators discussing policy and integrity rather than student search behaviour. Both have robust institutional frameworks (including NESH guidelines in Norway) and comparatively low documented misconduct; their P-Scores should be read with that proxy limitation in mind.</p>
